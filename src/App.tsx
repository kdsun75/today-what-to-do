    ...
    <div className="app-shell">
      ...
      <main id="top">
        ...
        <section className="event-section" id="events">
          ...
          {filteredEvents.length ? <div className="event-grid">{filteredEvents.map((event) => <EventCard key={event.id} event={event}/>)}</div> : <div className="empty-state"><span>🔎</span><h2>찾는 행사가 아직 없어요</h2><p>검색어나 카테고리를 바꿔 보세요.</p></div>}
        </section>
      </main>
